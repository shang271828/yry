...
def landmarks_by_face__(image):
    ...
    params = {
        ...
        #'api_key': '4xKKFPCzNGj8Yee-FK-8GktUqOivCGLo',
        #'api_secret': 'J3cGofpnXmNAU04bpcSw27LBsgtdjtci',
        #'api_key': 'tlDu_Qs0u8iCxaY3DOCXpbjYl8UyDjtg',
        #'api_secret': 'GIfG26ly_pOo4MA0QtFdguJF2fQ37SZx',
        'return_landmark': 1,
    }
    ...
    #    if not content.get('error_message', ''):
    #        return_info = content
    #    else:
    #        print(image)
    #        print(content.get('error_message'))
    #return return_info
